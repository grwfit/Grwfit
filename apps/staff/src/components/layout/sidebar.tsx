...
import {
  LayoutDashboard, Users, LogIn, CreditCard, TrendingUp,
  FileText, UserCog, Settings, Dumbbell, Globe, Maximize2, RefreshCw, MessageSquare, Award, Calendar,
} from "lucide-react";
...
const navItems = [
  ...
  { href: "/payments", label: "Payments", icon: CreditCard, module: "payments" as const },
  { href: "/renewals", label: "Renewals", icon: RefreshCw, module: "members" as const },
  { href: "/whatsapp", label: "WhatsApp", icon: MessageSquare, module: "members" as const },
